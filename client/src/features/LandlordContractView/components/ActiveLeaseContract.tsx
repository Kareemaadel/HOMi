                                    ...
                                    <>
                                        ...
                                        <div className="pdf-section">
                                            ...
                                            <div className="pdf-clause-list">
                                                ...
                                                <div className="pdf-clause-item">١٤. {previewLang === 'en' ? 'Jurisdiction: Digital copies provided to both parties. Subject to local courts.' : 'الاخصاص: نسختان رقميتان للطرفين. يخضع العقد للمحاكم المحلية.'}</div>
                                            </div>
                                        </div>

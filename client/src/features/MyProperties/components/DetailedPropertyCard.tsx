...
import { 
  ...
  FaUserCircle, FaCalendarAlt, FaChartLine, FaTools, FaEllipsisH 
} from 'react-icons/fa';
  ...
  return (
    <div className="detailed-card">
        ...
        <div className="image-overlay-tags">
            {/* Ensure property.status is one of: 'rented', 'available', 'pending' */}
        ...
        <div className="financial-overview">
          ...
          <div className="main-price">
            ...
            <div className="action-buttons">
                <button className="manage-btn">Manage Unit</button>
